...
import com.colenobi.hyperion.util.ItemNames;
...
public class ModItems
{
    ...
    private static void register()
    {
         ...
         *
         * */
        ITEMS.add(new ItemGun(new ResourceLocation(Reference.MOD_ID, "assaulter")).setCreativeTab(HyperionMod.TABGUNS));

        /* Registering custom ammo. Make sure you change in your gun json to use your custom ammo if you implement one */
        ITEMS.add(new ItemAmmo(new ResourceLocation(Reference.MOD_ID, "foam_dart")).setCreativeTab(HyperionMod.TABGUNS));
    }
