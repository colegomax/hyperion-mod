...
public class Reference
{
    ...
    public static final String MOD_NAME = "Hyperion";
    ...
    public static final String PROXY_CLIENT = "com.colenobi.hyperion.proxy.ClientProxy";
    public static final String PROXY_SERVER = "com.colenobi.hyperion.proxy.CommonProxy";
}
